...
class ExamenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adaptador= org.sierra.isoft.TemasListAdapter(this)
        recucleView.adapter=adaptador
        adaptador.setTemas(org.sierra.isoft.Globales.cuestionarioMalas!!)

        recucleView.layoutManager= LinearLayoutManager(this)


        Toast.makeText(applicationContext,"Valor:"+ org.sierra.isoft.Globales.cuestionarioMalas!!.size, Toast.LENGTH_LONG).show()

regresar.setOnClickListener {
    var i= Intent(applicationContext, org.sierra.isoft.MainActivity::class.java)
    startActivity(i)
}
